...
import { PoolDookEditor } from "@/components/editor/PoolDookEditor";
...
export default function CreatePage() {
  ...
  const handleEnhance = async () => {
    ...
    // Extract plain text from editor JSON (strip blank nodes, keep text)
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    try {
      const url = isEdit ? `/api/pool-dooks/${editId}` : "/api/pool-dooks";
...
function extractPlainText(node: import("@tiptap/react").JSONContent): string {
